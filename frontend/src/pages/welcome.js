            ...
            <Grid container justify="center">
                ...
                <Grid container justify="center">
                    <Grid item className={classes.buttonSpacing}>
                        <Button
                            onClick={() =>
                                props.setPage(Pages.CREATE_INDIVIDUAL_PROFILE)
                            }
                            className={classes.individualButton}
                        >
                            I'm an{" "}
                            <a className={classes.consumer}>individual</a>
                        </Button>
                        <br />
                        <Button
                            className={classes.orgButton}
                            onClick={() => props.setPage(Pages.SCAN)}
                        >
                            I'm an{" "}
                            <a className={classes.consumer}>organization</a>
                        </Button>
                    </Grid>
                </Grid>
